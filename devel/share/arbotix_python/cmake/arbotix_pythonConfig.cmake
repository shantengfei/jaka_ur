...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_python_SOURCE_PREFIX /home/shantengfei/catkin_ws/src/arbotix_ros/arbotix_python)
  set(arbotix_python_DEVEL_PREFIX /home/shantengfei/catkin_ws/devel)
  ...
  set(arbotix_python_INSTALL_PREFIX /home/shantengfei/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <mike@vanadiumlabs.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shantengfei/catkin_ws/src/arbotix_ros/arbotix_python/${idir}'.  Ask the maintainer 'Michael Ferguson <mike@vanadiumlabs.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${arbotix_python_dep}_FOUND)
      find_package(${arbotix_python_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${arbotix_python_dep} REQUIRED ${depend_list})
  endif()
